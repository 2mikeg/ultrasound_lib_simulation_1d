...
method_switcher.get("implicit")(indexes, geometry_unit  , layer_number, n_steps, dt, initial_velocity, df, name, saving_path,
                            main_path, interpolation_points, cfl, nodes, dimensionless=True, input_plot = True, save=True)

# fig_steps, low_limit, upper_limit, pause= 1, -5, 5, 0.1
